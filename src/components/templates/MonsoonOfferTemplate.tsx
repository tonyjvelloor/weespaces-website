...
export default function MonsoonOfferTemplate({ city }: { city?: string }) {
  const cityName = city ? city.charAt(0).toUpperCase() + city.slice(1) : "";
  const dynamicHeading = cityName ? `Register Your Business in ${cityName}` : "Register Your Business";
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <ScrollReveal delay={0.3} direction="left">
                ...
                <div className="bg-navy rounded-3xl p-8 shadow-2xl border border-white/10 relative overflow-hidden">
                  ...
                  <CampaignLeadForm branch="Monsoon Offer Campaign - Hero" defaultCity={cityName || "Kochi"} />
                </div>
              </ScrollReveal>
            </div>
          </div>
      ...
      <section className="py-20 bg-black/40 relative border-t border-white/5">
        <div className="container mx-auto px-6">
          <ScrollReveal>
            ...
            <div className="mb-12">
              <OfferPricingCards city={city} />
            </div>

            {/* EMBEDDED SOCIAL PROOF */}
            <div className="max-w-4xl mx-auto mt-16 border-t border-white/10 pt-16">
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center gap-1 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full mb-4">
                  <Star className="w-4 h-4 fill-accent text-accent" />
                  <Star className="w-4 h-4 fill-accent text-accent" />
                  <Star className="w-4 h-4 fill-accent text-accent" />
                  <Star className="w-4 h-4 fill-accent text-accent" />
                  <Star className="w-4 h-4 fill-accent text-accent" />
                  <span className="text-white/80 text-sm ml-2 font-bold tracking-widest uppercase">Trusted by 500+ Businesses</span>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 relative">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Rahul M.</div>
                      <div className="text-white/50 text-xs">Tech Startup Founder</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 relative">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Anjali K.</div>
                      <div className="text-white/50 text-xs">E-Commerce Seller</div>
                    </div>
                  </div>
                </div>
              </div>
