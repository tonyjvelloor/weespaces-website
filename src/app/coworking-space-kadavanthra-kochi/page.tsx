...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Coworking Space Kadavanthra Kochi | WeeSpaces',
    description: 'Best coworking space Kadavanthra Kochi. Just minutes away from MG Road, offering flexible desks, private offices, and meeting rooms.',
    url: 'https://www.weespaces.in/coworking-space-kadavanthra-kochi',
    images: [
      {
        url: data.heroImage,
        width: 1200,
        height: 630,
        alt: 'Coworking Space Kadavanthra Kochi | WeeSpaces',
      },
    ],
  },
};
...
const faqs = [
  { question: 'Is there a WeeSpaces coworking space in Kadavanthra?', answer: 'Our Ernakulam hub is located in Ravipuram on MG Road, which is extremely close and convenient for anyone in Kadavanthra.' },
  { question: 'What amenities do you offer?', answer: 'We provide high-speed WiFi, power backup, meeting rooms, and unlimited coffee/tea.' },
];

const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Coworking Space Kadavanthra Kochi | WeeSpaces',
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 justify-center">
        <div className="absolute inset-0 z-0">
          <Image src={data.heroImage} alt="Coworking Space Kadavanthra Kochi | WeeSpaces" fill sizes="100vw" className="object-cover object-center opacity-40" priority />
        ...
        <div className="container mx-auto px-6 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <ScrollReveal direction="up" className="space-y-6 md:space-y-8 z-10 relative">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight" dangerouslySetInnerHTML={{__html: `Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">Coworking Space</span><br />near Kadavanthra, Kochi`}}></h1>
            ...
            <div className="bg-navy-dark/40 border-l-4 border-accent p-4 rounded-r-lg max-w-xl">
              ...
              <p className="text-sm md:text-base text-white/90 font-medium leading-relaxed">
                Looking for a coworking space near Kadavanthra? Our MG Road hub is just minutes away, offering a vibrant community and top-notch amenities.
              </p>
            </div>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 border-t border-white/10">
        <ScrollReveal direction="up" className="prose prose-invert prose-lg max-w-none">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Your Ideal Coworking Space near Kadavanthra, Kochi</h2>
          <p dangerouslySetInnerHTML={{__html: `If you are searching for a <strong>coworking space in Kadavanthra, Kochi</strong>, our nearby Ravipuram hub on MG Road is the perfect fit. It offers unparalleled accessibility for professionals living in and around Kadavanthra.`}}></p>

          <h3 className="text-2xl font-bold mt-12 mb-4">Why Work Near Kadavanthra?</h3>
          <p dangerouslySetInnerHTML={{__html: `Kadavanthra is a premium residential and commercial area. Working just a stone\'s throw away on MG Road gives you the best of both worlds: a peaceful commute and a prestigious business address.`}}></p>
        </ScrollReveal>
      </section>
