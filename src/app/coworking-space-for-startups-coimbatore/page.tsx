...
export const metadata: Metadata = {
  title: 'Coworking Space for Startups in Coimbatore | WeeSpaces',
  description: 'Vibrant coworking space for startups in Coimbatore. Flexible seating, vibrant community, and startup-friendly amenities.',
};
...
export default function ConversionPage() {
  ...
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    "name": "WeeSpaces Coworking Space For Startups Coimbatore",
    ...
    "url": "https://www.weespaces.in/coworking-space-for-startups-coimbatore",
    ...
    <>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          <ScrollReveal direction="up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-accent">Coworking Space for Startups in Coimbatore</span>
            </h1>
            <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
              Vibrant coworking space for startups in Coimbatore. Flexible seating, vibrant community, and startup-friendly amenities. Join the WeeSpaces community and let us handle the operations while you focus on scaling.
            </p>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <ScrollReveal direction="right" className="bg-navy-light/50 backdrop-blur-md border border-white/10 p-8 rounded-3xl">
          ...
          <LeadForm branch="coimbatore" source="SEO: coworking-space-for-startups-coimbatore" />
        </ScrollReveal>
      </section>
    </div>
    </>
