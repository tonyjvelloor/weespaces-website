...
export const metadata: Metadata = {
  title: 'Virtual Office for GST Registration in Kochi | WeeSpaces',
  description: 'Get a premium business address in Kochi for GST registration and company incorporation. Dedicated mail handling and professional presence starting at just ₹10,000/year.',
};

export default function VirtualOfficeKochiPage() {
  return (
    <div className="pt-24 pb-20">
        ...
        <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center max-w-7xl">
          <ScrollReveal direction="up">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Virtual Office for <br/><span className="text-accent">GST Registration</span><br/> in Kochi
            </h1>
            <p className="text-lg text-white/70 mb-10 max-w-xl">
              Establish a premium business presence on MG Road, Kochi without physical office overhead. Perfect for startups, remote companies, and freelancers needing official address proof.
            </p>
          ...
          <ScrollReveal direction="left" delay={0.2} className="relative">
            <div id="get-started" className="glass p-8 rounded-3xl border border-white/10 relative z-10">
               <h3 className="text-2xl font-bold mb-6">Request Virtual Office in Kochi</h3>
      ...
      <section id="features" className="py-24 max-w-7xl mx-auto px-6">
        <ScrollReveal direction="up" className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">What's Included in Your Kochi <span className="text-accent">Virtual Office</span>?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <ScrollReveal delay={0.2}>
            <MouseGlowCard className="glass rounded-3xl p-8 h-full border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Premium MG Road Address</h3>
              <p className="text-white/70 leading-relaxed">
                Use our prestigious commercial address on MG Road, Ernakulam for your website, business cards, Google My Business, and marketing collateral.
              </p>
            </MouseGlowCard>
          </ScrollReveal>
