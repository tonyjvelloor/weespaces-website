...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Coworking Space Pattom Trivandrum | WeeSpaces',
    description: 'Premium coworking space in Pattom, Trivandrum. Modern shared office near Technopark with hot desks, dedicated desks, and private cabins.',
    url: 'https://www.weespaces.in/coworking-space-pattom-trivandrum',
    images: [
      {
        url: data.heroImage,
        width: 1200,
        height: 630,
        alt: 'Coworking Space Pattom Trivandrum | WeeSpaces',
      },
    ],
  },
};
...
const faqs = [
  { question: 'How much is a hot desk in Pattom?', answer: 'Hot desks at our Pattom, Trivandrum hub start at ₹4,500/month.' },
  { question: 'What are the timings for the Pattom coworking space?', answer: 'Members get 24/7 access to ensure flexibility for different time zones.' },
];

const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Coworking Space Pattom Trivandrum | WeeSpaces',
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 justify-center">
        <div className="absolute inset-0 z-0">
          <Image src={data.heroImage} alt="Coworking Space Pattom Trivandrum | WeeSpaces" fill sizes="100vw" className="object-cover object-center opacity-40" priority />
        ...
        <div className="container mx-auto px-6 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <ScrollReveal direction="up" className="space-y-6 md:space-y-8 z-10 relative">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight" dangerouslySetInnerHTML={{__html: `Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">Coworking Space</span><br />in Pattom, Trivandrum`}}></h1>
            ...
            <div className="bg-navy-dark/40 border-l-4 border-accent p-4 rounded-r-lg max-w-xl">
              ...
              <p className="text-sm md:text-base text-white/90 font-medium leading-relaxed">
                Join the most dynamic coworking space in Pattom, Trivandrum. Designed for IT professionals, startups, and remote workers.
              </p>
            </div>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 border-t border-white/10">
        <ScrollReveal direction="up" className="prose prose-invert prose-lg max-w-none">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Experience Coworking Space in Pattom, Trivandrum</h2>
          <p dangerouslySetInnerHTML={{__html: `Pattom is a major commercial node in the city. Our <strong>coworking space in Pattom Trivandrum</strong> provides an inspiring environment that fuels productivity and networking.`}}></p>

          <h3 className="text-2xl font-bold mt-12 mb-4">The Ultimate Shared Workspace</h3>
          <p dangerouslySetInnerHTML={{__html: `Whether you need a hot desk for a day or a dedicated desk for months, our Pattom hub offers flexible plans, enterprise-grade WiFi, and a community of like-minded professionals.`}}></p>
        </ScrollReveal>
      </section>
