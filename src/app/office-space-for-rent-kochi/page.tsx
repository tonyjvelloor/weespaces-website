...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Office Space for Rent in Ernakulam, Kochi | WeeSpaces',
    description: 'Premium office space for rent in Ernakulam, Kochi. Fully furnished workspaces, private cabins, and dedicated desks at MG Road.',
    url: 'https://www.weespaces.in/office-space-for-rent-kochi',
    images: [
      {
        url: data.heroImage,
        width: 1200,
        height: 630,
        alt: 'Office Space for Rent in Ernakulam, Kochi | WeeSpaces',
      },
    ],
  },
};
...
const faqs = [
  { question: 'How much does office space for rent in Ernakulam cost?', answer: 'Our pricing starts at ₹5,000/month for hot desks, with custom quotes for private offices.' },
  { question: 'Where is the Ernakulam office located?', answer: 'We are located on the 4th floor of Palal Tower, MG Road, Ravipuram.' },
];

const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Office Space for Rent in Ernakulam, Kochi | WeeSpaces',
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 justify-center">
        <div className="absolute inset-0 z-0">
          <Image src={data.heroImage} alt="Office Space for Rent in Ernakulam, Kochi | WeeSpaces" fill sizes="100vw" className="object-cover object-center opacity-40" priority />
        ...
        <div className="container mx-auto px-6 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <ScrollReveal direction="up" className="space-y-6 md:space-y-8 z-10 relative">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight" dangerouslySetInnerHTML={{__html: `Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">Office Space for Rent</span><br />in Ernakulam`}}></h1>
            ...
            <div className="bg-navy-dark/40 border-l-4 border-accent p-4 rounded-r-lg max-w-xl">
              ...
              <p className="text-sm md:text-base text-white/90 font-medium leading-relaxed">
                Locate your business at the commercial heart of Kerala. We offer fully furnished office space for rent in Ernakulam, right on MG Road.
              </p>
            </div>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 border-t border-white/10">
        <ScrollReveal direction="up" className="prose prose-invert prose-lg max-w-none">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Premium Office Space for Rent in Ernakulam</h2>
          <p dangerouslySetInnerHTML={{__html: `Ernakulam is the bustling commercial hub of Kochi. Finding the right <strong>office space for rent in Ernakulam</strong> is crucial for networking and growth. WeeSpaces offers top-tier facilities designed to elevate your business.`}}></p>

          <h3 className="text-2xl font-bold mt-12 mb-4">Flexible Renting Options on MG Road</h3>
          <p dangerouslySetInnerHTML={{__html: `Instead of traditional leases, our managed office spaces provide a zero-CapEx solution. Enjoy enterprise-grade WiFi, meeting rooms, and 24/7 access in the heart of the city.`}}></p>
        </ScrollReveal>
      </section>
