...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Coworking Space Kozhikode | Premium Shared Office | WeeSpaces',
    description: 'Best coworking space in Kozhikode. Flexible hot desks, private offices, and virtual office setup near Cyberpark.',
    url: 'https://www.weespaces.in/coworking-space-kozhikode',
    images: [
      {
        url: data.heroImage,
        width: 1200,
        height: 630,
        alt: 'Coworking Space Kozhikode | Premium Shared Office | WeeSpaces',
      },
    ],
  },
};
...
const faqs = [
  { question: 'What is the cost of coworking in Kozhikode?', answer: 'Our hot desks start at an affordable ₹4,000/month in Kozhikode.' },
  { question: 'Do you provide meeting rooms?', answer: 'Yes, our Kozhikode hub features state-of-the-art meeting rooms available for booking.' },
];

const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Coworking Space Kozhikode | Premium Shared Office | WeeSpaces',
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 justify-center">
        <div className="absolute inset-0 z-0">
          <Image src={data.heroImage} alt="Coworking Space Kozhikode | Premium Shared Office | WeeSpaces" fill sizes="100vw" className="object-cover object-center opacity-40" priority />
        ...
        <div className="container mx-auto px-6 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <ScrollReveal direction="up" className="space-y-6 md:space-y-8 z-10 relative">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight" dangerouslySetInnerHTML={{__html: `Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">Coworking Space</span><br />in Kozhikode`}}></h1>
            ...
            <div className="bg-navy-dark/40 border-l-4 border-accent p-4 rounded-r-lg max-w-xl">
              ...
              <p className="text-sm md:text-base text-white/90 font-medium leading-relaxed">
                Experience a vibrant community at the best coworking space in Kozhikode. Perfect for freelancers, startups, and growing teams.
              </p>
            </div>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 border-t border-white/10">
        <ScrollReveal direction="up" className="prose prose-invert prose-lg max-w-none">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">The Premier Coworking Space in Kozhikode</h2>
          <p dangerouslySetInnerHTML={{__html: `Embrace a new way of working. Our <strong>coworking space in Kozhikode</strong> brings together the city\'s top creatives and tech professionals in a highly productive environment.`}}></p>

          <h3 className="text-2xl font-bold mt-12 mb-4">Modern Amenities & Community</h3>
          <p dangerouslySetInnerHTML={{__html: `Enjoy access to high-speed internet, ergonomic seating, and regular networking events. Whether you call it Calicut or Kozhikode, our space is designed to help you succeed.`}}></p>
        </ScrollReveal>
      </section>
