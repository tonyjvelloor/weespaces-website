...
export const metadata: Metadata = {
  title: 'Virtual Office in Coimbatore | WeeSpaces',
  description: 'Premium virtual office solutions in Coimbatore. Get a professional business address, GST registration support, and mail handling for your startup or remote team.',
};

export default function VirtualOfficeCoimbatorePage() {

  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "WeeSpaces Virtual Office Coimbatore",
    ...
    <>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          <ScrollReveal direction="up">
            ...
            <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
              Get a premium business address in Coimbatore's top commercial hubs without the overhead of physical office space. Ideal for remote teams, freelancers, and growing startups.
            </p>
      ...
      <section id="features" className="py-24 max-w-7xl mx-auto px-6">
        <ScrollReveal direction="up" className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto">Our virtual office plans provide the credibility and administrative support required to scale your business professionally in Coimbatore.</p>
        </ScrollReveal>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <ScrollReveal delay={0.1}>
            <MouseGlowCard className="glass rounded-3xl p-8 h-full border border-white/10">
              ...
              <p className="text-white/70 leading-relaxed">
                Use our prime commercial addresses in Coimbatore on your website, business cards, and marketing materials.
              </p>
            </MouseGlowCard>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <MouseGlowCard className="glass rounded-3xl p-8 h-full border border-white/10">
              ...
              <p className="text-white/70 leading-relaxed">
                Receive all necessary documentation, NOCs, and agreements required to officially register your business and obtain your GST number in Tamil Nadu.
              </p>
            </MouseGlowCard>
          </ScrollReveal>
