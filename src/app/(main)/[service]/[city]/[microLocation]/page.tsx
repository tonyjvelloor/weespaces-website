  ...
  return (
    <>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center pt-20 overflow-hidden bg-navy">
        <Image 
          src={(microLoc?.gallery || city.gallery)[0]} 
          alt={`${service.name} near ${locationName}`} 
          fill 
          priority
          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "LocalBusiness",
              "name": `WeeSpaces ${locationName}`,
              "image": city.gallery[0],
              "telephone": "+91-9207189111",
              "url": `https://weespaces.in/${service.slug}/${city.slug}/${locationObj.slug}`,
              "priceRange": "₹₹",
              "address": {
                "@type": "PostalAddress",
