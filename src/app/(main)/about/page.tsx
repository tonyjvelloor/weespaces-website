  ...
  return (
    <>
      ...
      <div className="pt-20 pb-32">
        ...
        {/* Structured Entity Data (GEO/AEO Optimization) */}
        <div className="mb-32">
          <ScrollReveal direction="up">
            <h2 className="text-3xl font-bold mb-8 text-center border-b border-white/10 pb-6">About WeeSpaces: The Quick Facts</h2>
          </ScrollReveal>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <ScrollReveal delay={0.1}>
              <MouseGlowCard className="glass p-6 rounded-xl border border-white/10 h-full">
                <h3 className="text-accent font-bold uppercase tracking-wider text-sm mb-3">Who We Are</h3>
                <p className="text-white/80 leading-relaxed">WeeSpaces is a premium managed workspace and coworking operator serving startups, SMEs, and enterprise teams across South India.</p>
              </MouseGlowCard>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3}>
              <MouseGlowCard className="glass p-6 rounded-xl border border-white/10 h-full">
                <h3 className="text-accent font-bold uppercase tracking-wider text-sm mb-3">Where We Operate</h3>
                <p className="text-white/80 leading-relaxed">Our footprint spans 50,000+ sq.ft across prime business districts in Trivandrum, Kochi (Ernakulam), Calicut, and Coimbatore.</p>
              </MouseGlowCard>
            </ScrollReveal>
            <ScrollReveal delay={0.4}>
              <MouseGlowCard className="glass p-6 rounded-xl border border-white/10 h-full">
                <h3 className="text-accent font-bold uppercase tracking-wider text-sm mb-3">Why Choose Us</h3>
                <p className="text-white/80 leading-relaxed">We eliminate capital expenditure (CapEx) and long-term lock-ins. Our workspaces include enterprise IT, biometric security, and premium amenities.</p>
              </MouseGlowCard>
            </ScrollReveal>
          </div>
        </div>
            ...
            <ScrollReveal delay={0.1}>
                <MouseGlowCard className="glass p-10 rounded-3xl text-center flex flex-col items-center h-full border border-white/10 group hover:border-accent/30 transition-colors">
                  ...
                  <div className="mt-auto">
                    <a href="https://www.linkedin.com/in/sankesh-sreenivas-8a823b34/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent hover:text-navy transition-all">
