...
const urlPath = "/office-space-for-rent-coimbatore";
...
export default function OfficeSpaceCoimbatorePage() {
      ...
      <section className="py-20 relative bg-navy-dark border-t border-white/5">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Why Choose Our Managed Offices in Coimbatore?</h2>
