                ...
                {locationId === 'coimbatore' && (
                  <>
                    ...
                    <div className="inline-flex items-center gap-3">
                      ...
                      <WhatsAppButton 
                        className="inline-flex items-center gap-2 bg-[#25D366] text-white font-bold px-4 py-2 rounded-full text-xs hover:bg-[#20b858] transition-colors"
                        contextOverride={{ city: data.name, service: 'Landing Page' }}
                      >
