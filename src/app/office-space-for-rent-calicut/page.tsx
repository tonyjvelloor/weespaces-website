...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Office Space for Rent in Calicut | WeeSpaces',
    description: 'Discover premium office space for rent in Calicut. Close to Cyberpark, featuring modern amenities, private cabins, and flexible terms.',
    url: 'https://www.weespaces.in/office-space-for-rent-calicut',
    images: [
      {
        url: data.heroImage,
        width: 1200,
        height: 630,
        alt: 'Office Space for Rent in Calicut | WeeSpaces',
      },
    ],
  },
};
...
const faqs = [
  { question: 'Where is your office space in Calicut?', answer: 'We are located at Neeloth Plaza, East Nadakkave, opposite Malayalam Manorama.' },
  { question: 'Can I rent a private cabin?', answer: 'Yes, we offer private office cabins tailored for your team starting from ₹16,000/month.' },
];

const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Office Space for Rent in Calicut | WeeSpaces',
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 justify-center">
        <div className="absolute inset-0 z-0">
          <Image src={data.heroImage} alt="Office Space for Rent in Calicut | WeeSpaces" fill sizes="100vw" className="object-cover object-center opacity-40" priority />
        ...
        <div className="container mx-auto px-6 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <ScrollReveal direction="up" className="space-y-6 md:space-y-8 z-10 relative">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight" dangerouslySetInnerHTML={{__html: `Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent-light">Office Space for Rent</span><br />in Calicut`}}></h1>
            ...
            <div className="bg-navy-dark/40 border-l-4 border-accent p-4 rounded-r-lg max-w-xl">
              ...
              <p className="text-sm md:text-base text-white/90 font-medium leading-relaxed">
                Find the perfect office space for rent in Calicut. Situated near Cyberpark, combining cultural richness with modern tech infrastructure.
              </p>
            </div>
      ...
      <section className="py-24 max-w-5xl mx-auto px-6 border-t border-white/10">
        <ScrollReveal direction="up" className="prose prose-invert prose-lg max-w-none">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Your Next Office Space for Rent in Calicut</h2>
          <p dangerouslySetInnerHTML={{__html: `Calicut is rapidly becoming a destination for tech startups and creative agencies. Finding an <strong>office space for rent in Calicut</strong> that meets modern standards is easy with WeeSpaces.`}}></p>

          <h3 className="text-2xl font-bold mt-12 mb-4">Fully Managed Workspaces</h3>
          <p dangerouslySetInnerHTML={{__html: `Located in East Nadakkave, our workspaces are fully furnished and managed. Enjoy hassle-free operations without worrying about maintenance, internet downtime, or utility bills.`}}></p>
        </ScrollReveal>
      </section>
