...
content = re.sub(
    r"(id: 'kaloor'[\s\S]*?services: \['coworking-space', 'virtual-office'\]\s*})",
    r"\1,\n" + kochi_locations,
    content
)
...
content = re.sub(
    r"(id: 'sasthamangalam'[\s\S]*?services: \['coworking-space', 'private-office', 'virtual-office', 'meeting-room'\],\s*})",
    r"\1,\n" + trivandrum_locations,
    content
)
...
content = re.sub(
    r"(id: 'east-hill'[\s\S]*?services: \['coworking-space', 'private-office', 'virtual-office', 'meeting-room'\],\s*})",
    r"\1,\n" + calicut_locations,
    content
)
...
content = re.sub(
    r"(id: 'peelamedu'[\s\S]*?services: \['coworking-space', 'private-office', 'virtual-office', 'meeting-room'\],\s*})",
    r"\1,\n" + coimbatore_locations,
    content
)
